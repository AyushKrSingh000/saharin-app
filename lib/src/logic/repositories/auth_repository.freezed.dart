...
class _$AuthStateImpl implements _AuthState {
  ...
  @override
  String toString() {
    return 'AuthState(authUser: $authUser, idToken: $idToken, email: $email, password: $password, checkbox: $checkbox, status: $status)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, authUser, idToken, email, password, checkbox, status);
