...
import 'package:saharin/src/ui/provider/provider_insurance_tab/insurnace_requests_section.dart';
...
@RoutePage()
class ProvderInsuranceTabPage extends ConsumerStatefulWidget {
  const ProvderInsuranceTabPage({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _ProvderInsuranceTabPageState();
}

class _ProvderInsuranceTabPageState
    extends ConsumerState<ProvderInsuranceTabPage> {
  @override
